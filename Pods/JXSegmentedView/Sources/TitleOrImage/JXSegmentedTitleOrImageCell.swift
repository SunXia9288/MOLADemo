...
open class JXSegmentedTitleOrImageCell: JXSegmentedTitleCell {
    ...
    override open func reloadData(itemModel: JXSegmentedBaseItemModel, selectedType: JXSegmentedViewItemSelectedType) {
    ...
    override open func preferredTitleZoomAnimateClosure(itemModel: JXSegmentedTitleItemModel, baseScale: CGFloat) -> JXSegmentedCellSelectedAnimationClosure {
        guard let myItemModel = itemModel as? JXSegmentedTitleOrImageItemModel else {
    ...
    override open func preferredTitleStrokeWidthAnimateClosure(itemModel: JXSegmentedTitleItemModel, attriText: NSMutableAttributedString) -> JXSegmentedCellSelectedAnimationClosure {
        guard let myItemModel = itemModel as? JXSegmentedTitleOrImageItemModel else {
    ...
    override open func preferredTitleColorAnimateClosure(itemModel: JXSegmentedTitleItemModel) -> JXSegmentedCellSelectedAnimationClosure {
        guard let myItemModel = itemModel as? JXSegmentedTitleOrImageItemModel else {
